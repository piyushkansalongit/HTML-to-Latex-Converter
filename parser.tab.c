...
# define YYTOKENTYPE
  enum yytokentype
  {
    beginStartTag = 258,
    finishTag = 259,
    finishSelfClosingTag = 260,
    beginEndTag = 261,
    TAG = 262,
    RAWTEXT = 263,
    ATTRIBUTE = 264,
    ATTRIBUTE_ASSIGN = 265,
    ATTRIBUTE_VALUE = 266
  };
#endif
...
{
       0,    32,    32,    33,    34,    35,    36,    39,    40,    50,
      61,    64,    65,    70,    71,    81,    96,   102,   105,   108,
     111,   114,   119,   124,   127
};
#endif
...
{
  "$end", "error", "$undefined", "beginStartTag", "finishTag",
  "finishSelfClosingTag", "beginEndTag", "TAG", "RAWTEXT", "ATTRIBUTE",
  "ATTRIBUTE_ASSIGN", "ATTRIBUTE_VALUE", "$accept", "grammar", "startTag",
  "closingTag", "selfClosingTag", "rawtext", "beginST", "beginET", "fT",
  "fSCT", "tag", "attribute", "attribute_assign", "attribute_value", YY_NULLPTR
};
#endif
...
{
       2,   -19,   -19,   -19,    11,     2,     2,     2,     2,    12,
      12,   -19,   -19,   -19,   -19,   -19,   -19,    -3,     5,   -19,
     -19,   -19,   -19,   -19,   -19,     8,    10,   -19,    10,   -19,
       5,    -1,   -19,   -19,   -19
};
...
{
       2,    17,    18,    16,     0,     2,     2,     2,     2,     0,
       0,     1,     3,     5,     6,     4,    21,     0,     0,    19,
      20,    22,    23,     8,    14,     0,     0,    12,     0,    24,
       0,     0,    10,     9,    15
};
...
{
      27,    19,    20,    19,    20,     1,    21,    22,     2,    19,
       3,    11,    32,    33,    12,    13,    14,    15,    22,    16,
      34,    29,    31,    18,     0,    28
};

static const yytype_int8 yycheck[] =
{
      18,     4,     5,     4,     5,     3,     9,    10,     6,     4,
       8,     0,    30,    31,     5,     6,     7,     8,    10,     7,
      31,    11,    28,    10,    -1,    25
};
...
static const yytype_uint8 yystos[] =
{
      ...
      19,     0,    13,    13,    13,    13,     7,    22,    22,     4,
       5,     9,    10,    20,    21,    23,    24,    20,    24,    11,
      25,    25,    20,    20,    21
};
